...
#############################################################################
{
    ...
    'description': 'The POS Kitchen Screen in Odoo 18 is a feature that '
    ...
    'author': 'Boomibalagan',
    'company': 'Boomibalagan',
    'maintainer': 'Boomibalagan',
    'website': "https://www.cybrosys.com",
    'depends': ['pos_restaurant'],

    'data': [
        'security/kitchen_model_access.xml',
        ...
        'data/models_pos_kitchen_screen.xml',
    ],
    'assets': {
