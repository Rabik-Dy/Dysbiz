...
class HrEmployeeBase(models.AbstractModel):
    ...
    # Modified Code ===============
    include_cc = fields.Many2many(
        'res.users',
        'hr_employee_res_users_cc_rel',
        'hr_employee_id',
        'res_users_id',
        string='Include CC',
        domain=lambda self: [
        ...
        help='Select users who should be included in CC for leave notifications.',
        tracking=True,
        groups='hr.group_hr_manager'  # 👈 Only HR Admins will see this field
    )
    # Modified Code ===============
    tz = fields.Selection(
